...
resource "aws_ssm_parameter" "backend_sg_id" {
  name  = "/${var.project_name}/${var.environment}/backend_sg_id"  #This SG will store its SG id in SSM Parameter store.
  type  = "String"
  value =  module.backend.sg_id
}
resource "aws_ssm_parameter" "frontend_sg_id" {
  name  = "/${var.project_name}/${var.environment}/frontend_sg_id"  #This SG will store its SG id in SSM Parameter store.
  type  = "String"
...
resource "aws_ssm_parameter" "ansible_sg_id" {
  name  = "/${var.project_name}/${var.environment}/ansible_sg_id"  #This SG will store its SG id in SSM Parameter store.
  type  = "String"
